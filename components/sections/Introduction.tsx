    ...
    <section className="w-full">
      ...
      >
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-5xl  text-[var(--foreground)] mb-6 leading-tight">
          Hi from <span className="text-[var(--accent)]">{SITE.name}</span>,
          <br />
          {SITE.role}
        </h1>

        <p className="text-lg text-[var(--muted)] max-w-3xl leading-relaxed">
          I build modern, scalable web and mobile applications with a strong
          emphasis on clean code and great user experience.
        </p>
      </motion.div>
