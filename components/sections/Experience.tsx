...
const experiences: ExperienceItem[] = [
  {
    ...
    description:
      "Spearheading development and maintenance of cutting-edge web and mobile applications using React.js, Next.js, and React Native. Architected real-time video and voice calling platforms with advanced SIP integration, WebSocket communication, and RESTful API implementation, delivering seamless communication experiences.",
    // rating: "4.30/5"
  },
  {
